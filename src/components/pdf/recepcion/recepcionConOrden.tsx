                    ...
                    <View style={styles.columna}>
                        ...
                        <View style={styles.fila}>
                            <View style={styles.columnaLeft}>
                                ...
                                <Text style={styles.parrafo}>{props.data.fechaDoc.toLocaleDateString('es-ES', {
                                    year: 'numeric',
                                    month: 'long',
                                    day: 'numeric'
                                })}
                        ...
                        <View style={styles.table}>
                            ...
                            {props.data.articulos.map((Articulo, index) => (
                                <View style={styles.tableRow} key={index}>
                                    ...
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{Articulo.precio}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{Articulo.observacion}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
