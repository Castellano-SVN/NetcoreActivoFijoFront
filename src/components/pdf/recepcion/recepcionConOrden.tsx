...
export default function PDFConOrden({ data, location, estados }: props) {
  return (
    <Document>
      <Page style={styles.page}>
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.headerText}>
            ...
            {/* Puedes habilitar esto si tienes un folio */}
            {/* <Text>Folio: {data.folio}</Text> */}
          </View>
        </View>

        {/* Título */}
        <Text style={styles.title}>Recepción con Orden de Compra</Text>
        {/* Descripción general */}
        {(data.descripcion && data.descripcion.length >= 0) ?? (
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionLabel}>Descripción general:</Text>
            <Text style={styles.descriptionText}>{data.descripcion || ""}</Text>
          </View>
        )}
        {/* Información general */}
        <View style={styles.section}>
          <View style={styles.column}>
            ...
            <Text style={styles.value}>{location.centrocosto || "-"}</Text>

            <Text style={styles.label}>Tipo de Documento</Text>
            <Text style={styles.value}>
              {data.tipo === 1 ? "Factura" : "Guía de Despacho"}
            </Text>
          ...
          <View style={styles.column}>
            ...
            <Text style={styles.value}>{location.bodega || "-"}</Text>

            <Text style={styles.label}>Número de Documento</Text>
            <Text style={styles.value}>{data.numDoc || "-"}</Text>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          {data.articulos.map((a, index) => (
            ...
            >
              <Text style={styles.tableCol}>{a.codigo}</Text>
              <Text style={styles.tableCol}>{a.nombre}</Text>
        ...
        <Text style={styles.footer}>
          Documento generado automáticamente - Sistema Netcore ©{" "}
