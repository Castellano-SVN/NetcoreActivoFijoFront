...
export default function PDFQuiebreStock() {
                    ...
                    <View style={styles.columna}>
                        ...
                        <View style={styles.fila}>
                            <View style={styles.columnaLeft}>
                                ...
                                <Text style={styles.parrafo}>15-01-2024</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.table}>
                            ...
                            {[...Array(3)].map((_, index) => (
                                <View style={styles.tableRow} key={index}>
                                    ...
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>Codigo-SubFamilia {index + 1}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                    ...
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>Stock Critico {index + 1}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>Proceso Compra {index + 1}</Text>
                                    </View>
                                </View>
                            ))}
                        </View>
