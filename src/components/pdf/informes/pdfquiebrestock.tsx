...
import { IBodegaQuiebre, OutPutQuiebreStockFormValues } from '@/interfaces/creation';
...
export default function PDFQuiebreStock(props: props) {
    ...
    const fechaInforme = fechaActual.toLocaleDateString('es-ES', {
        weekday: 'long',
        year: 'numeric',
        month: 'long',
        day: 'numeric'
            ...
            <Document>
                <Page style={styles.page}>
                    ...
                    <View style={styles.columna}>
                        <Text style={styles.titleCenter}>Informe Quiebre de Stock</Text>
                        ...
                        <View style={styles.table}>
                            ...
                            {props.dataQuiebrePdf.map((q, index) => (
                                <View style={styles.tableRow} key={index}>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{index + 1}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.articulo.codigo}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                    ...
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.almacen.bodega.nombre}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.cantidad}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.cantidadMinima}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={[styles.tableCell, { fontWeight: "bold" }]}>{q.cantidadMinima - q.cantidad}</Text>
                                    </View>
                                </View>
                             ))} 
                        </View>
                        ...
                        <View style={styles.brBig}></View>
                         ...
                         <View style={styles.fila}>
                            <View style={styles.columnaLeft}>
                                ...
                                <Text style={styles.textoDebajoLineaLeft}>Nombre y Firma </Text>
                            </View>
