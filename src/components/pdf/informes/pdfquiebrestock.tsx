...
interface props {
    dataQuiebre: OutPutQuiebreStockFormValues;
}


export default function PDFQuiebreStock(props: props) {

    const fechaInforme = props.dataQuiebre.FechaInforme.toLocaleDateString('es-ES', {
        weekday: 'long',
        year: 'numeric',
        month: 'long',
        day: 'numeric'
            ...
            <Document>
                <Page style={styles.page}>
                    ...
                    <View style={styles.columna}>
                        <Text style={styles.titleCenter}>Quiebre de Stock</Text>
                        ...
                        <View style={styles.fila}>
                            <View style={styles.columnaLeft}>
                                <View style={styles.fila}>
                                    <Text style={styles.subTitle}>Fecha Informe</Text>
                                </View>
                                <Text style={styles.parrafo}>{fechaInforme}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.table}>
                            <View style={styles.tableRow}>
                                ...
                                <View style={styles.tableColHeader}>
                                    <Text style={styles.tableCellHeader}>Codigo-SubFamilia</Text>
                                </View>
                                <View style={styles.tableColHeader}>
                                ...
                                <View style={styles.tableColHeader}>
                                    <Text style={styles.tableCellHeader}>Stock Critico</Text>
                                </View>
                                <View style={styles.tableColHeader}>
                                    <Text style={styles.tableCellHeader}>Proceso Compra</Text>
                                </View>

                            </View>
                            {props.dataQuiebre.QuiebreStock.map((q, index) => (
                                <View style={styles.tableRow} key={index}>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{index + 1}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.CodigoArticulo}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.CodigoFamilia}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.Familia}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.CodigoSubFamilia}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.SubFamilia}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.DescripcionArticulo}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>Cantidad Registro Sistema {q.CantidadSistema}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.StockCritico}</Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{q.ProcesoCompra}</Text>
                                    </View>
                                </View>
                            ))}
                        </View>
