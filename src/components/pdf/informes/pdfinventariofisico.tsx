...
export default function PDFInventarioFisico(props: props) {
  return (
    <>
      <Document>
        <Page style={styles.page}>
          ...
          <View style={styles.columna}>
            ...
            <View style={styles.table}>
              ...
              {props.data.registros.map((e, index) => (
                <View style={styles.tableRow} key={index}>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>{index + 1}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>{e.encargado}</Text>
                  </View>
                  <View style={styles.tableCol}>
                  ...
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>{e.codigoArticulo}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>
                      {e.codigoFamilia + " " + e.familia}
                    </Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>
                      {e.codigoSubFamilia + " " + e.subFamilia}
                    </Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>
                  ...
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>{e.cantidadSistema}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>{e.cantidadFisica}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text style={styles.tableCell}>
