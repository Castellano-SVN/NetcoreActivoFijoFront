...
import { OutPutFormValues } from '@/interfaces/creation';
...
interface props {
    data: OutPutFormValues;
}

export default function PDFGuiaEntrega(props: props) {
        ...
        <Document>
            <Page>
                ...
                <View style={styles.table}>
                    ...
                    {props.data.ParteSalida.map((salida, index) => (
                        <View style={styles.tableRow} key={index}>
                            <View style={styles.tableCol} >
                                <Text style={styles.tableCell}>{salida.CodigoArticulo}</Text>
                            </View>
                            <View style={styles.tableCol}>
                                <Text style={styles.tableCell}>{salida.CodigoFamilia}</Text>
                            </View>
                            <View style={styles.tableCol}>
                                <Text style={styles.tableCell}>{salida.Familia}</Text>
                            </View>
                            <View style={styles.tableCol}>
                                <Text style={styles.tableCell}>{salida.CodigoSubFamilia}</Text>
                            </View>
                            <View style={styles.tableCol}>
                                <Text style={styles.tableCell}>{salida.SubFamilia}</Text>
                            </View>
                            <View style={styles.tableCol}>
                                <Text style={styles.tableCell}>{salida.DescripcionArticulo}</Text>
                            </View>
                            <View style={styles.tableCol}>
