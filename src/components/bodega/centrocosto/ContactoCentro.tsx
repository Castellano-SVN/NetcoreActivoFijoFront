            ...
            <div className="my-2">
                <div className="flex flex-wrap">
                    ...
                    <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 p-2">
                        ...
                        <Input type='number' {...register("Celular", { setValueAs: (value) => value === "" ? undefined : Number(value) })} />
                        <label className="label text-error">
                ...
                <div className="flex flex-wrap">
                    <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 p-2">
                        ...
                        <Input type='number' {...register("Telefono1", { setValueAs: (value) => value === "" ? undefined : Number(value) })} className="bg-white" />
                        <label className="label text-error">
                    ...
                    <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 p-2">
                        ...
                        <Input type='number' {...register("Telefono2", { setValueAs: (value) => value === "" ? undefined : Number(value) })} />
                        <label className="label text-error">
                    ...
                    <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 p-2">
                        ...
                        <Input type='number' {...register("Fax", { setValueAs: (value) => value === "" ? undefined : Number(value) })} />
                        <label className="label text-error">
