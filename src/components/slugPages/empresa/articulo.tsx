        ...
        <>
                ...
                <div className="w-full md:w-1/2 mt-2 md:mt-0">
                    <div className="flex flex-row flex-wrap gap-2 justify-center md:justify-start">
                        {['startsWith','contains','endsWith','exact'].map(type => (
                            <label key={type} className="flex items-center cursor-pointer ml-2">
                                <input
                                    type="radio"
                                    name="searchType"
                                ...
                                <span className="ml-1 text-sm">
                                    {type === 'startsWith' ? 'Comienza con' : type === 'contains' ? 'Contiene' : type === 'endsWith' ? 'Termina con' : 'Exacto'}
                                </span>
                            </label>
                        ))}
                    </div>
            ...
            {noItems ? (
                <>
                    ...
                    />
                    <button className="px-12 btn btn-primary mt-2" onClick={() => props.create()}>
            ...
            <div className="hover:shadow-md border rounded-md shadow">
                ...
                <div className="flex flex-row p-3 bg-[#FAF6FF] justify-around">
                    ...
                    <div className="flex space-x-4">
                        <a onClick={editArticulo} className="flex items-center cursor-pointer hover:font-bold">
                            <span className="underline text-primary text-sm">Editar</span>
                            <FaPenToSquare className="ml-2 text-primary" />
                        </a>
                        <a onClick={handleClickDelete} className="flex items-center cursor-pointer hover:font-bold">
                ...
                <dialog open className="modal">
                    <div className="modal-box">
                        ...
                        <div className="modal-action flex justify-center">
                            <button className="btn btn-outline btn-primary mr-2 w-20" onClick={handleClickClose}>No</button>
                            <button className="btn btn-outline btn-accent w-20" onClick={handleClickYes}>Sí</button>
                        </div>
                    </div>
                </dialog>
            )}
