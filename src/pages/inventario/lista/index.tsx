import {
  ...
  import { IEmpresa, InventarioFisicoFormValue } from "../../../interfaces/creation";
  ...
  <div className="col-start-4 col-end-5 flex items-center">
    <a
      onClick={() => router.push(`/inventario/lista/${props.inventarioFisico.numero}?empresa=${props.empresa}`)}
