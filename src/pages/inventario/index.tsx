...
import { IBodega, ICentroCosto, IEmpresa, IInventarioFisicoEstado, IMarca, InventarioFisicoFormValue } from "@/interfaces/creation";
import { IAlmacen, IAlmacenArticulo } from "@/interfaces/modules/IAlmacen.interface";
import { api_getAllAlmacenArticuloByEmpByCenByBodByAlm, api_getAllAlmacenByEmpByCenByBod, api_getAllBodegaByEmpresaYCentroCosto, api_getAllCentroCostoByEmpresa, api_getAllEmpresas, api_getAllInventarioFisicoEstados, api_getAllMarcas, api_postInventarioFisico } from "@/services/bodega.service";
...
export default function Index() {
    ...
    const [dataInventarioFisicoEstados, setDataInventarioFisicoEstados] = useState<IInventarioFisicoEstado[]>([])
    ...
    const getAllInventarioFisicoEstados = async () => {
        try {
            const inventarioFisicoEstado = await api_getAllInventarioFisicoEstados(jwt);
    ...
    const InventarioFisicoSchema = z.object({
        InventarioFisico: z.object({
            ...
            FuncionarioId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }).optional(),
            Numero: z.number({ required_error: "Campo requerido", invalid_type_error: "Campo inválido" }),
            FechaRegistro: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            FechaInicio: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            FechaTermino: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
        }),
        InventarioFisicoDetalle: z.object({
            EmpresaId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            InventarioFisicoId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            FuncionarioId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }).optional(),
            CentroCostoId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }).optional(),
            BodegaId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }).optional(),
            DependenciaLocacion: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }).optional(),
            FechaRegistro: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }).optional(),
        }),
        InventarioFisicoRegistro: z.object({
            EmpresaId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            InventarioFisicoId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            InventarioFisicoDetalleId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            FuncionarioId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            PersonaConteoId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            AnoNumero: z.number({ required_error: "Campo requerido", invalid_type_error: "Campo inválido" }),
            SubFamiliaId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            ArticuloId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            MarcaId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            EstadoCodigo: z.number({ required_error: "Campo requerido", invalid_type_error: "Campo inválido" }),
            LugarFisicoConteo: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            LocacionId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            ProgramaId: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            Presentacion: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            Observaciones: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            Codigo: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
            NumeroUnidades: z.number({ required_error: "Campo requerido", invalid_type_error: "Campo inválido" }),
            FechaRegistro: z.string({ required_error: "Campo requerido", invalid_type_error: "Opción inválida" }),
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                {selectedArticulos.length !== 0 ? (
                                    <>
                                                    ...
                                                    <Table.Row hover>
                                                        ...
                                                        <span>
                                                            <select className="mt-1 block w-4/8 py-2 px-3 border border-primary bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                                                                {dataInventarioFisicoEstados.map((estado, index) => (
                                        ...
                                        <button type="submit" className="btn btn-outline btn-accent mt-3">Guardar Inventario</button>
                                    </>
                                ) : (
