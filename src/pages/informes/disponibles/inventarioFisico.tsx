...
import { api_getAllAlmacenByEmpByCenByBod, api_getAllArticulosByAlmacen, api_getAllBodegaByEmpresaYCentroCosto, api_getAllCentroCostoByEmpresa } from "@/services/bodega.service";
...
function BuscarArticulos(props: props) {
    ...
    const { register, handleSubmit, formState: { errors }, setValue, getValues, reset, control, watch } = methods;
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, value, name, ref } }) => (
                                    <Select
                                        ...
                                        options={Articulo}
                                        onChange={(val) => setValue("ArticuloId", val?.id as string)}
                                        menuPortalTarget={document.body}
                                        loadingMessage={() => "Cargando opciones..."}
