      ...
      <div className="flex items-center justify-center">
        <div className="container shadow-md md:mx-24 mt-2 sm:mt-4 rounded-lg">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col mb-4 md:ml-4 lg:ml-4 xl:ml-4">
              <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 xl:w-1/3 p-2">
              ...
              <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 xl:w-1/3 p-2">
                <label className="label">
                  <span className="label-text">Numero documento</span>
                </label>
              ...
              <div className="flex flex-col w-full sm:w-1/3 lg:w-1/3 p-2">
                <label className="label ">
                  <span className="label-text">Fecha de documento</span>
                </label>
